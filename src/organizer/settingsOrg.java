 ...
 * @author user
 */
public class settingsOrg extends javax.swing.JFrame {
...
if (sess.getUid() == 0) {
    ...
    private void settMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settMouseClicked
       settingsOrg st = new settingsOrg();
       st.setVisible(true);
       this.dispose();
...
if (confirm == JOptionPane.YES_OPTION) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(settingsOrg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new settingsOrg().setVisible(true);
            }
        });
    }
